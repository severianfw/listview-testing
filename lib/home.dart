...
class TitleText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text("Pokemon List", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold)
      ),
    );
  }
}
...
class Pokemon {
  ...
  Pokemon({this.name, this.type}); // constructor dari dart
}
...
class PokemonList extends StatelessWidget {
  ...
  // github.com/jonathandarwin/dscugm-flutter-widget
}